...
# `quantmod`, `quandl` 팩키지 {#quantmod-quandl-pkg}
...
## 금융 주식 데이터 가져오기 {#quantmod-quandl-import}
...
## 환율/경제 데이터 가져오기 {#quantmod-quandl-import-econometric}

``` {r economic-data-sources}
## 2.2. 환율: 원화/1달러
