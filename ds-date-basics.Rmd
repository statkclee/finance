...
``` {r coursera-dates-and-time-basics}
...
``` {r coursera-dates-and-time-basics-type-check}
x <- Sys.time()
x
p <- as.POSIXlt(x)
names(unclass(p))
...
``` {r coursera-dates-and-time-basics-conversion}
...
``` {r coursera-operation-diff-timezone}
